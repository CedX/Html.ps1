...
Describe "New-TimeElement" {
	It 'should support [DateOnly] objects for the "datetime" attribute' {
		...
		Should-BeString '<time datetime="1974-05-03"></time>' (time -DateTime $value) -CaseSensitive
	}
	...
	It 'should support [DateTime] objects for the "datetime" attribute' {
		...
		Should-BeLikeString '<time datetime="1974-05-03T08:16:32.*"></time>' (time -DateTime $value) -CaseSensitive
	}
	...
	It 'should support [TimeOnly] objects for the "datetime" attribute' {
		...
		Should-BeLikeString '<time datetime="08:16:32.*"></time>' (time -DateTime $value) -CaseSensitive
	}

	It 'should support [TimeSpan] objects for the "datetime" attribute' {
		$value = New-TimeSpan -Days 3 -Hours 5 -Minutes 19 -Seconds 7
		Should-BeString '<time datetime="P3DT5H19M7S"></time>' (time -DateTime $value) -CaseSensitive
	}
}
